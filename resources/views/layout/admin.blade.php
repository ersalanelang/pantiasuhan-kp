...
<head>
  ...
  <title>UPT RPA Wiloso Projo </title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light" style="font-size:12.0pt">UPT RPA Wiloso Projo  </span>
      <!-- <span class="brand-text font-weight-light" style="font-size:12.0pt"></span> -->
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          @if(Auth::user()->role == 'admin')
            <div class="image">
              <img src="{{ asset('template/dist/img/admin.png')}}" style="width: 35px;;" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
              <a href="/profil" class="d-block">{{Auth::user()->name}}</a>
            </div>
            <h8><span class="badge rounded-pill bg-success "  style="vertical-align:sub;">Admin</span><h8>
          @endif
          @if(Auth::user()->role == 'operator')
            ...
            <h8><span class="badge rounded-pill bg-primary"  style="vertical-align:sub;">Operator</span><h8>
          @endif
          @if(Auth::user()->role == 'Kepala UPT')
            <div class="image">
            ...
            <h8><span class="badge rounded-pill bg-danger"  style="vertical-align:sub;">Kepala UPT</span><h8>
          @endif
      </div>
  ...
  @yield('content')
  <!-- /.content-wrapper -->
  <footer class="main-footer mt-4" style="font-size:10.0pt">
    <span>Copyright &copy; 2022 <a href="https://kominfo.jogjakota.go.id/">Dinas Komunikasi Informatika dan Persandian Kota Yogyakarta</a>.</span>
