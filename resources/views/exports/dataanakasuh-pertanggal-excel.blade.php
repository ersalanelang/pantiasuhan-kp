...
<table>        
    <thead>
        ...
        <tr>
            <th colspan="20" style="text-align: center;">UPT RUMAH PENGASUHAN ANAK WILOSO PROJO - Berdasarkan Filter {{$cetak}}</th>
        </tr>
        <tr>
            <th colspan="8">Tanggal Awal : {{$tglAwal}}</th>
        </tr>
        <tr>
            <th colspan="8">Tanggal Akhir : {{$tglAkhir}}</th>
        </tr>
        <tr>
            <th></th>
        </tr>
